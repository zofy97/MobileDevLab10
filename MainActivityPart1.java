package com.example.sophi.lab10;
...
public class MainActivityPart1 extends Activity implements View.OnClickListener
{
    ...
    public void onClick(View view)
    {
        ...
        if (networkInfo != null && networkInfo.isConnected())   {
            ...
            urlText.setText("no network connection available");
        }
    }

    /* Use your own Asynchronous Task to create a task away from the main UI thread.
    This task takes a URL string and uses it to create an HttpUrlConnection.
    Once the connection has been established, the AsyncTask downloads the contents of the webpage
        ...
        protected void onPostExecute(String result) {
            try {
                ...
                for (int i = 0; i < jArray.length(); i++) {
                    ...
                    boolean completed = jObject.getBoolean("completed");

                    textView.setText((CharSequence) jObject);
                } // End Loop
